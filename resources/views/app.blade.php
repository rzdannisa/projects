...
>>>>>>> c9aa5721ce89b8073da2a90766ef77598778d7ce
    ...
    <!-- Bootstrap CSS -->    
    <link href="{{ url('dp/metro.css') }}" rel="stylesheet">
    <link href="{{ url('dp/metro-icons.css') }}" rel="stylesheet">
    <link href="{{ url('dp/metro-responsive.css') }}" rel="stylesheet">
    <link href="{{ url('dp/metro-schemes.css') }}" rel="stylesheet">

    <link href="{{ url('dp/docs.css') }}" rel="stylesheet">
...
>>>>>>> c9aa5721ce89b8073da2a90766ef77598778d7ce
    ...
    <script src="{{ url('js/jquery.nicescroll.js') }}" type="text/javascript"></script><!--custome script for all page-->
